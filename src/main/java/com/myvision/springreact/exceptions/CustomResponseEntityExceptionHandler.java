...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<Object> handleUserNotFoundException(UserAlreadyExistException exception, WebRequest request) {
        UserAlreadyExistExceptionResponse userAlreadyExistExceptionResponse = new UserAlreadyExistExceptionResponse(exception.getMessage());
        return new ResponseEntity<>(userAlreadyExistExceptionResponse, HttpStatus.BAD_REQUEST);
    }
}
